...
public interface IPathResolutionClient
{
    ...
    Task<PathRewriteOptions> ResolvePathsAsync(string workspaceIdOrName, string itemIdOrName, string path, string? itemType = null, CancellationToken cancellationToken = default);
}
